...
if feet_fiber >= 500:   #If they purchase more than 500 feet, they will be charged $.50 per foot
    fiber_cost = feet_fiber * .50  #If they purchase more than 500 feet, they will be charged $.50 per foot
elif feet_fiber >= 250:
    fiber_cost = feet_fiber * .70  #If the user purchases more than 250 feet, they will be charged $.70 per foot
